...
This directory contains development notes, proposals, and design documents for the make-bowerbird-deps framework.
...
### Accepted
- `01-dependency-override.md` - Command-line override system with keyword arguments
